...
matrix::Vector2f differential_drive_control_guidance::computeGuidance(const matrix::Vector2f& current_pos, const matrix::Vector2f& waypoint, const matrix::Vector2f& previous_waypoint, const matrix::Vector2f& next_waypoint, float vehicle_yaw, float dt, float max_forwards_velocity, float max_angular_velocity)
{
